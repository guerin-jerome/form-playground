...
import { getSessionStorageFormValues, synchronizeLocalAndRemoteData } from "../../persistence/sessionStorage";
...
export const StepForm = () => {
    ...
    const {handleSubmit, getValues, formState:{errors}, watch} = methods

    const values = watch();

    useEffect(() => synchronizeLocalAndRemoteData("stepForm", values), [ values]);
    ...
    return (
        <>
            ...
            <div></div>{JSON.stringify(getValues())}
